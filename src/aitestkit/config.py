...
class ProjectConfig(BaseModel):
    """Project-level configuration from .aitestkit/config.yaml."""
...
def load_project_config(project_root: Path | None = None) -> ProjectConfig | None:
    """Load project configuration from .aitestkit/config.yaml.
    ...
    config_path = project_root / ".aitestkit" / "config.yaml"
